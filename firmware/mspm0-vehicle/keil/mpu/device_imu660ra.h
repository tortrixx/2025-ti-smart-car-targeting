...
/*********************************************************************************************************************
* 接线定义          查看  device_imu_interface.h 中接口资源定义
********************************************************************************************************************/

#ifndef _device_imu660ra_h_
#define _device_imu660ra_h_
...
// 返回参数     range                   IMU660RA 加速度量程 详见  device_imu660ra.h 中 imu660ra_acc_range_enum 定义
// 参数说明     *physical_data          IMU660RA 的物理量数据缓冲指针
// 返回参数     imu660ra_state_enum     IMU660RA 状态码 详见  device_imu660ra.h 中 imu660ra_state_enum 定义
...
// 参数说明     *measurement_data       IMU660RA 的测量数据缓冲指针
// 返回参数     range                   IMU660RA 加速度量程 详见  device_imu660ra.h 中 imu660ra_gyro_range_enum 定义
// 参数说明     *physical_data          IMU660RA 的物理量数据缓冲指针
// 返回参数     imu660ra_state_enum     IMU660RA 状态码 详见  device_imu660ra.h 中 imu660ra_state_enum 定义
...
// 参数说明     item                    IMU660RA 配置参照  device_imu660ra.h 中 imu660ra_config_item_enum 枚举体定义
// 返回参数     imu660ra_state_enum     IMU660RA 状态码 详见  device_imu660ra.h 中 imu660ra_state_enum 定义
