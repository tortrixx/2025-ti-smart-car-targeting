...
// 自身头文件
#include "device_imu_interface.h"
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK void imu_delay_ms (uint32 ms)
{
    delay_ms(ms);
}
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK uint8 imu_assert (uint8 pass, char *str, char *file, int line)
{
    return (pass ?  NO_ERROR : debug_message_handler( DEBUG_OUTPUT_LEVEL_DEVICE, (pass), (str), file, line));
}
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK void spi_transfer_8bit_register (const uint8 *data_out, uint8 *data_in, uint32 data_len)
{
    while(data_len --)
    {
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK void imu_write_8bit_register (uint8 addr, uint8 reg, uint8 data)
{
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK void imu_write_8bit_registers (uint8 addr, uint8 reg, const uint8 *data, uint32 len)
{
#if (IMU_INTERFACE_SPI == IMU_INTERFACE_TYPE)
    IMU_CS(0);
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK uint8 imu_read_8bit_register (uint8 addr, uint8 reg)
{
#if (IMU_INTERFACE_SPI == IMU_INTERFACE_TYPE)
    uint8 data = 0;
    IMU_CS(0);
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK void imu_read_8bit_registers (uint8 addr, uint8 reg, uint8 *data, uint32 len)
{
#if (IMU_INTERFACE_SPI == IMU_INTERFACE_TYPE)
    IMU_CS(0);
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK uint8 imu_interface_deinit (void)
{
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
 WEAK uint8 imu_interface_init (void)
{
    uint8 return_state = 1;
    do
    {
