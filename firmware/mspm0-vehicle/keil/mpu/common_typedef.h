...
//=================================================== 类型定义 ===================================================
#define USE_TYPEDEF      (1)                                                 // 是否启用类型定义申明
...
#define  NO_ERROR     ( 0 )                                                   // 通用状态返回检查值 通常情况下返回 0 代表无异常
#define  ERROR        ( 1 )                                                   // 通用状态返回检查值 通常情况下返回 非 0 值代表异常码

#define  ENABLE       ( 1 )                                                   // 使能 定义
#define  DISABLE      ( 0 )                                                   // 禁止 定义

#define  TRUE         ( 1 )                                                   // 布尔值 真 定义
#define  FALSE        ( 0 )                                                   // 布尔值 假 定义
...
#define  PACKED_ENABLE    
#define  PACKED_DISABLE   
...
// 文件定位
#define  FILE_MESSAGE     ( __FILE__ )
#define  LINE_MESSAGE     ( __LINE__ )
// -------------------------- MDK IDE 适配 --------------------------
...
#define  PACKED           __attribute__((packed))
#define  PACKED_ENABLE    // _Pragma("pack(push,1)")
#define  PACKED_DISABLE   // _Pragma("pack(pop)")
...
// ADS 仅支持 2/4 字节对齐
#define  PACKED           
#define  PACKED_ENABLE    _Pragma("pack 2")
#define  PACKED_DISABLE   _Pragma("pack 0")
